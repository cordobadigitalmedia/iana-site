import { z } from 'zod';
import fieldDefinitions from './preliminary-business-fields.json';
...
export const preliminaryBusinessSchema = buildSchemaFromFields(fieldDefinitions.fields);

export type PreliminaryBusinessFormData = z.infer<typeof preliminaryBusinessSchema>;
